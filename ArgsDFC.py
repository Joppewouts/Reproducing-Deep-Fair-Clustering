class args:
    ...
    def set_mnist_ups(self):
        ...
        self.encoder_0_legacy_path = None  # unnecessary, used to load original paper models
        self.encoder_0_path = None
        self.encoder_1_legacy_path = None  # unnecessary, used to load original paper models
